...
static int do_struct(void) {
	...
	if (access(sanctioned_templates, R_OK) < 0) {
		...
		fprintf(fp, "b:amd64.aquabsd.0922a:https:github.com/inobulles/aquabsd-core/releases/download/v0922a-beta/base.txz:100185616:78a3c4fc7d4a083cd40940812aad175cae114023ec90d3227d9694a123e731fc\n");
		fprintf(fp, "k:amd64.aquabsd.0922a:https:github.com/inobulles/aquabsd-core/releases/download/v0922a-beta/kernel.txz:47545272:074c5d8f709fb5b585d5ab689ebbd5595115e9d896b762e4151c9db2da98ddae\n");
