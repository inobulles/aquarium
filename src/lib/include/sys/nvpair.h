...
#include <sys/types.h>
// the following comes from 'include/os/freebsd/spl/sys/types.h' in the OpenZFS source tree
...
// #include <sys/time.h>
// the following comes from 'include/os/freebsd/spl/sys/time.h' in the OpenZFS source tree
